...
{
    public class EFDbContextEntityMapping : IEFDbContextEntityMapping, ISingleton
    {
        ...
        {
            var dbquery = dbContextType.GetTypeInfo().Assembly.GetTypes().Where(o => o.CanAssignableTo(typeof(CafDbContext<>)));
            ...
            .GetProperties(BindingFlags.Public | BindingFlags.Instance)
                              where
                              property.PropertyType.CanAssignableTo(typeof(DbSet<>))
